          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin size={18} className="text-luxury-gold mr-2 mt-1 flex-shrink-0" />
                <span className="text-gray-300">123 Fashion Avenue, Marrakech, Morocco</span>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="text-luxury-gold mr-2 flex-shrink-0" />
                <a href="tel:+212-123-456-789" className="text-gray-300 hover:text-luxury-gold transition-colors">+212-123-456-789</a>
              </li>
              <li className="flex items-center">
