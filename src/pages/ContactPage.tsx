  ...
  return (
    <>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-serif text-luxury-black mb-1">Visit Us</h3>
                    <p className="text-luxury-gray">123 Fashion Avenue</p>
                    <p className="text-luxury-gray">Marrakech, Morocco</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-gray">+212-123-456-789</p>
                    <p className="text-luxury-gray">+212-987-654-321</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-luxury-cream">
        <div className="container">
          <h2 className="text-2xl font-serif text-luxury-black text-center mb-8">Visit Our Boutique</h2>
          ...
          <div className="bg-white p-4">
            ...
            <div className="text-center mt-6">
              <p className="text-luxury-black font-medium">123 Fashion Avenue, Marrakech, Morocco</p>
              <p className="text-luxury-gray">Find us in the heart of Marrakech's fashion district</p>
            </div>
          </div>
        </div>
      </section>
